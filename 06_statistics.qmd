# How to draw insights from data {#sec-statistics}

\
This chapter is about traditional statistical methods that focus on understanding relationships between variables, providing a probabilistic interpretation of these relationships, quantifying uncertainty in results, and making inference about a population.
It provides the fundamental theory for many data science tasks.
